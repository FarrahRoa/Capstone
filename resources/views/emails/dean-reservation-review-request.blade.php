...
<body style="font-family: sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <p>A requester has confirmed an AVR or Lobby reservation by email. Please approve or reject it. <strong>Opening this message does not record a decision.</strong> Use the buttons below (or the review link) to submit your choice.</p>
    <p>
    ...
    <p style="margin: 24px 0;">
        <form method="POST" action="{{ $approveUrl }}" style="display: inline-block; margin: 0 8px 8px 0;">
            <button type="submit" style="display: inline-block; background: #166534; color: #fff; padding: 12px 20px; text-decoration: none; border-radius: 4px; border: none; font-size: 15px; cursor: pointer;">
                Approve reservation
            </button>
        </form>
        <form method="POST" action="{{ $rejectUrl }}" style="display: inline-block; margin: 0 8px 8px 0;">
            <button type="submit" style="display: inline-block; background: #b91c1c; color: #fff; padding: 12px 20px; text-decoration: none; border-radius: 4px; border: none; font-size: 15px; cursor: pointer;">
                Reject reservation
            </button>
        </form>
    </p>
    <p>If the buttons do not work in your email app, open this page to review and submit your decision:</p>
    <p>
        <a href="{{ $reviewUrl }}"
